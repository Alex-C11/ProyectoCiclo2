 ...
 * @author Asullom
 */
public class EstiloTablaFootRendererXX extends DefaultTableCellRenderer {
   ...
   // private ImageIcon iconoBuscar = new ImageIcon(getClass().getResource("/igu/imgs/img/ico_buscar.png"));
    ...
    public EstiloTablaFootRendererXX() {
     ...
     * @param tipo
     */
    public EstiloTablaFootRendererXX(String tipo) {
        this.tipo = tipo;
    }
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focused, int row, int column) {
        ...
        if (row == x - 1) {
           ...
           // this.setTableCellRendererComponent(table, value, false, focused, row, column);
        } else {
            //selected = true;
